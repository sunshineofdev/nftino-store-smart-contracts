...
const infuraApikey = "";
const mnemonic = process.env.NFTINO_MNEMONIC;
if (!mnemonic) {
  throw new Error(`
    You are missing a environment variable called NFTINO_MNEMONIC - please set one
    e.g. export NFTINO_MNEMONIC='<your seed phrase>'
  `);
}
